...
(() => {
  ...
  // ── Character helpers ────────────────────────────────────────────────────
    const CHARACTERS = [
    { id: 'arien',       name: 'Arien',        subtitle: 'the Tidemaster',    accent: '#4A9BB5', texture: 'waves',
    ...
    { id: 'bain',        name: 'Bain',          subtitle: 'the Bounty Hunter', accent: '#B03050', texture: 'scales',
    ...
    { id: 'brogan',      name: 'Brogan',        subtitle: 'the Destroyer',     accent: '#C88030', texture: 'stone',
    ...
    { id: 'brynn',       name: 'Brynn',         subtitle: 'the Seeker',        accent: '#C87840', texture: 'grid',
    ...
    { id: 'cutter',      name: 'Cutter',        subtitle: 'the Sky Pirate',    accent: '#3AACCC', texture: 'waves',
    ...
    { id: 'dodger',      name: 'Dodger',        subtitle: 'the Warlock',       accent: '#A02030', texture: 'smoke',
    ...
    { id: 'emmit',       name: 'Emmitt',        subtitle: 'the Traveler',      accent: '#4090D0', texture: 'runes', special: '⏪',
    ...
    { id: 'garrus',      name: 'Garrus',        subtitle: 'the Gladiator',     accent: '#C03030', texture: 'scales',
    ...
    { id: 'gydion',      name: 'Gydion',        subtitle: 'the Archwizard',    accent: '#C8A030', texture: 'runes',
    ...
    { id: 'hanu',        name: 'Hanu',          subtitle: 'the Trickster',     accent: '#CC3828', texture: 'embers', special: '⚡',
    ...
    { id: 'ignatia',     name: 'Ignatia',       subtitle: 'the Mad',           accent: '#D03020', texture: 'embers', special: '🌀',
    ...
    { id: 'min',         name: 'Min',           subtitle: 'the Dragonmonk',    accent: '#D05020', texture: 'embers',
    ...
    { id: 'misa',        name: 'Misa',          subtitle: 'the Samurai',       accent: '#A82840', texture: 'scales',
    ...
    { id: 'mortimer',    name: 'Mortimer',      subtitle: 'the Awakener',      accent: '#C03878', texture: 'smoke',
    ...
    { id: 'mrak',        name: 'Mrak',          subtitle: 'the Rockshaper',    accent: '#3A9858', texture: 'stone',
    ...
    { id: 'nebkher',     name: 'NebKher',       subtitle: 'the Harbinger',     accent: '#30A898', texture: 'sand',
    ...
    { id: 'razzle',      name: 'Razzle',        subtitle: 'the Ringmaster',    accent: '#C02840', texture: 'diamonds',
    ...
    { id: 'rowenna',     name: 'Rowenna',       subtitle: 'the Vanguard',      accent: '#4A6880', texture: 'stone',
    ...
    { id: 'sabina',      name: 'Sabina',        subtitle: 'the Commander',     accent: '#B87830', texture: 'grid',
    ...
    { id: 'silverarrow', name: 'Silverarrow',   subtitle: 'the Pathfinder',    accent: '#28A060', texture: 'leaves',
    ...
    { id: 'snorri',      name: 'Snorri',        subtitle: 'the Runescribe',    accent: '#7050B8', texture: 'runes',
    ...
    { id: 'swift',       name: 'Swift',         subtitle: 'the Sharpshooter',  accent: '#88A030', texture: 'grid',
    ...
    { id: 'takahide',    name: 'Takahide',      subtitle: 'the Warlord',       accent: '#2898A8', texture: 'grid',
    ...
    { id: 'tali',        name: 'Tali',          subtitle: 'the Spirit Caller', accent: '#40B0D0', texture: 'hex',
    ...
    { id: 'tigerclaw',   name: 'Tigerclaw',     subtitle: 'the Cutpurse',      accent: '#C03830', texture: 'scales',
    ...
    { id: 'trinkets',    name: 'Trinkets',      subtitle: 'the Scavenger',     accent: '#3ABAB8', texture: 'sand',
    ...
    { id: 'ursafar',     name: 'Ursafar',       subtitle: 'the Savage',        accent: '#2878A8', texture: 'waves',
    ...
    { id: 'wasp',        name: 'Wasp',          subtitle: 'the Warmaiden',     accent: '#9060C0', texture: 'hex',
    ...
    { id: 'whisper',     name: 'Whisper',       subtitle: 'the Outcast',       accent: '#901830', texture: 'smoke',
    ...
    { id: 'widget',      name: 'Widget & Pyro', subtitle: 'the Scavenger Duo', accent: '#28A890', texture: 'leaves',
    ...
    { id: 'wuk',         name: 'Wuk',           subtitle: 'the Grove Guardian',accent: '#C03028', texture: 'leaves',
    ...
    { id: 'xargatha',    name: 'Xargatha',      subtitle: 'the Changed',       accent: '#38B048', texture: 'leaves',
  ...
  function applyCharacterTheme() {
    ...
    view.dataset.texture = c.texture || '';
