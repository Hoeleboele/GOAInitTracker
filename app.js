...
(() => {
  ...
  // ── Character helpers ────────────────────────────────────────────────────
    ...
    { id: 'arien',       name: 'Arien',        subtitle: 'the Tidemaster',    accent: '#70B858',
      quotes: ['The tide does not ask permission. Neither do I.', 'Elegance is not weakness. My blade has never missed.', 'Every current bends to me. Can you say the same?'] },
    { id: 'bain',        name: 'Bain',          subtitle: 'the Bounty Hunter', accent: '#6888C8',
      quotes: ["There's a price on your head. I already spent it.", 'My sister takes the gold. I take the shot.', 'Run all you want. The bolt is already in the air.'] },
    { id: 'brogan',      name: 'Brogan',        subtitle: 'the Destroyer',     accent: '#B07040',
      quotes: ["I don't need to be fast. I just need one swing.", 'Every scar I carry was worth giving.', 'They called me slow. They called me that once.'] },
    { id: 'brynn',       name: 'Brynn',         subtitle: 'the Seeker',        accent: '#D07898',
      quotes: ['The higher the wall, the better the view.', "My picks don't distinguish between ice and armor.", "Every obstacle is an opportunity. I've found many."] },
    { id: 'cutter',      name: 'Cutter',        subtitle: 'the Sky Pirate',    accent: '#50A8C0',
      quotes: ["Gold doesn't spend itself. That's what I'm for.", 'My brother takes the shot. I take everything else.', "The sky is free. Everything on it — that's mine."] },
    { id: 'dodger',      name: 'Dodger',        subtitle: 'the Warlock',       accent: '#C0A830',
      quotes: ["I don't bury the dead. I put them to work.", 'Every corpse on this field owes me a favor.', 'Death is just another resource. I waste nothing.'] },
    { id: 'emmit',       name: 'Emmitt',        subtitle: 'the Traveler',      accent: '#8080CC', special: '⏪',
      quotes: ["I've seen how this ends. Let's try a different path.", "Speed is not running away. It's arriving first.", "Time is a river. I'm the one with the oar."] },
    { id: 'garrus',      name: 'Garrus',        subtitle: 'the Gladiator',     accent: '#9080C0',
      quotes: ['The arena remembers every name. Yours ends today.', 'One howl and they scatter. I prefer it when they run.', 'Man and hound, bound by glory. Fear us both.'] },
    { id: 'gydion',      name: 'Gydion',        subtitle: 'the Archwizard',    accent: '#58C0A0',
      quotes: ['Every page of my spellbook has ended a dynasty.', 'You face a library of devastation. Pick your chapter.', 'Wisdom and power are the same word in my book.'] },
    { id: 'hanu',        name: 'Hanu',          subtitle: 'the Trickster',     accent: '#CC4030', special: '⚡',
      quotes: ["Blink and you'll miss me. I'll already be there.", "I don't need to hit hard. I just need your plan to fail.", "Alone I'm a nuisance. With friends, I'm a catastrophe."] },
    { id: 'ignatia',     name: 'Ignatia',       subtitle: 'the Mad',           accent: '#C060D8', special: '🌀',
      quotes: ["Order is just chaos that hasn't woken up yet.", 'I rolled the dice. The dice caught fire. Close enough.', 'They said unpredictable like it was an insult.'] },
    { id: 'min',         name: 'Min',           subtitle: 'the Dragonmonk',    accent: '#E0B040',
      quotes: ['Dragon, crane, serpent — pick which kills you faster.', 'I fight in stances. You fight in panic. Fair enough.', 'The smoke clears. By then, the mine has already spoken.'] },
    { id: 'misa',        name: 'Misa',          subtitle: 'the Samurai',       accent: '#E07070',
      quotes: ["A single breath. A single cut. Then I'm already gone.", 'Honor is not slow. Watch how fast I prove it.', 'They said she can fly. The last thing they ever said.'] },
    { id: 'mortimer',    name: 'Mortimer',      subtitle: 'the Awakener',      accent: '#70B870',
      quotes: ['Death is not an ending. It is an introduction.', 'My minions march to the beat. Quite literally.', "I don't mourn the fallen. I conduct them."] },
    { id: 'mrak',        name: 'Mrak',          subtitle: 'the Rockshaper',    accent: '#C04040',
      quotes: ['The stone speaks to me. Today it says: flatten them.', 'I am not slow. I am inevitable.', 'You cannot fight the mountain. You can only survive it.'] },
    { id: 'nebkher',     name: 'NebKher',       subtitle: 'the Harbinger',     accent: '#D0A858',
      quotes: ['My mirror walks where I do not. Even I forget which is real.', 'The sands of Atlantis remember my name. You should too.', "Mwahahaha — yes, that's mandatory. Now kneel."] },
    { id: 'razzle',      name: 'Razzle',        subtitle: 'the Ringmaster',    accent: '#F04880',
      quotes: ["Which one is the real me? Honestly, I've lost track.", 'Step right in — and pray the exit is real.', "Three of me, none of us takes a hit. Marvelous, isn't it?"] },
    { id: 'rowenna',     name: 'Rowenna',       subtitle: 'the Vanguard',      accent: '#D07840',
      quotes: ["I go first so others don't have to.", 'There is no glory in a cowardly victory.', "Fair is not weak. Ask anyone I've beaten."] },
    { id: 'sabina',      name: 'Sabina',        subtitle: 'the Commander',     accent: '#88B8D8',
      quotes: ['By the time you see my pistol, the trap is already set.', "Victory is not luck. It's preparation meeting chaos.", "I don't shoot first. I position first. Then I shoot first."] },
    { id: 'silverarrow', name: 'Silverarrow',   subtitle: 'the Pathfinder',    accent: '#B8D0E8',
      quotes: ["I've mapped every path. This is the one we take.", 'Distance is my armor. I need no other.', 'They think terrain slows me. Terrain is my shortcut.'] },
    { id: 'snorri',      name: 'Snorri',        subtitle: 'the Runescribe',    accent: '#A8C0D8',
      quotes: ['The rune does not lie. I merely choose which truth to write.', 'Carve the right symbol and reality bends to you.', 'Every ability has a better version. I write the upgrade.'] },
    { id: 'swift',       name: 'Swift',         subtitle: 'the Sharpshooter',  accent: '#78D898',
      quotes: ['One shot. One truth.', "Far for the rifle, close for the blast. I'm ready either way.", 'The jetpack is for a better angle. Not for running.'] },
    { id: 'takahide',    name: 'Takahide',      subtitle: 'the Warlord',       accent: '#C89060',
      quotes: ['Nations kneel. Armies follow. I nap afterward.', 'The sake flows. The tactics hold. Victory is already mine.', "Why rush? I've already won. I'm just being polite."] },
    { id: 'tali',        name: 'Tali',          subtitle: 'the Spirit Caller', accent: '#D8A0C0',
      quotes: ['The spirits do not forgive those who disturb their rest.', 'Every totem I place is a promise. The ice delivers it.', 'The battlefield freezes. The spirits smile. So do I.'] },
    { id: 'tigerclaw',   name: 'Tigerclaw',     subtitle: 'the Cutpurse',      accent: '#E8A030',
      quotes: ["What's yours is yours — until I blink through you.", "Fastest hands in Atlantis. Not that you'd feel them.", "I was never here. Your coins disagree."] },
    { id: 'trinkets',    name: 'Trinkets',      subtitle: 'the Scavenger',     accent: '#C8D060',
      quotes: ['Why fight them myself when the turret is right there?', "One guard's trash is my greatest military asset.", 'Dig in. Build up. Let steel do the talking.'] },
    { id: 'ursafar',     name: 'Ursafar',       subtitle: 'the Savage',        accent: '#A87840',
      quotes: ['Pain is a teacher. I have graduated.', "I'm the slowest thing on this field. None of that matters.", "Rage is not a weakness. It's the dial turning to eleven."] },
    { id: 'wasp',        name: 'Wasp',          subtitle: 'the Warmaiden',     accent: '#88C840',
      quotes: ['Stay in the field or leave it. I control both.', 'The boomerang comes back. So does the voltage.', 'They called it reckless. The field was already live.'] },
    { id: 'whisper',     name: 'Whisper',       subtitle: 'the Outcast',       accent: '#A888D0',
      quotes: ['The wounded cannot hide. Blood has a scent.', 'Run. It only makes the chase worth having.', 'I sentence you — not to death. To running from me.'] },
    { id: 'widget',      name: 'Widget & Pyro', subtitle: 'the Scavenger Duo', accent: '#58C8E0',
      quotes: ["Pyro breathes fire. I aim it. We're very professional.", "Two minds, one plan. Usually Pyro's. I just survive it.", 'The temple walls echo our names. For good reason.'] },
    { id: 'wuk',         name: 'Wuk',           subtitle: 'the Grove Guardian',accent: '#E06840',
      quotes: ['The grove does not forgive trespassers. Neither do I.', 'Plant enough trees and the battlefield becomes my home.', 'Every root I grow is a trap waiting to wake.'] },
    { id: 'xargatha',    name: 'Xargatha',      subtitle: 'the Changed',       accent: '#B04060',
      quotes: ["Look into my eyes. I promise it won't hurt.", 'I have shed what I was. What remains is power.', 'They came closer when I sang. They stopped when I squeezed.'] },
  ];
